...
export default function ContactUs() {
  ...
  Contact Arabian Amenity Travels – Global Tours & Corporate Travel Enquiries
      ...
      <section className="relative py-20 px-6 md:px-12 lg:px-24 bg-gradient-to-b from-white to-gray-100">
        ...
        <motion.form
          ...
          className="max-w-2xl mx-auto bg-white rounded-3xl shadow-2xl p-10 border border-gray-100 space-y-8 backdrop-blur-lg"
        >
          {/* SUCCESS & ERROR */}
          ...
          <div className="relative group">
            <input
              ...
              className="peer w-full pt-6 pb-3 px-4 border-b-2 border-gray-300 bg-transparent 
                         text-gray-900 placeholder-transparent focus:outline-none 
                         focus:border-blue-600 transition-all disabled:bg-gray-100 disabled:cursor-not-allowed"
              placeholder=" "
            />
            <label
              htmlFor="name"
              className="absolute left-4 top-1 text-gray-500 text-sm transition-all
  ...
  <a href="tel:+97142648306" className="text-blue-600 hover:underline">
    +971 4 2648306
              ...
              <p><strong>Email:</strong> ops@arabianamenity.com</p>
              <p className="max-w-2xl mx-auto">
                <strong>Head Office:</strong> Office 400-8, 4th Floor |
                Fahidi Heights Office Tower | Bur Dubai | Dubai | UAE
              </p>
            </div>
          </motion.div>
        </div>
